...
export declare type TypesStore = string | number | boolean | null;
export declare type Store<T, K extends keyof T> = Map<K, T[K]>;
export declare type StoreBackup<T> = Map<keyof T, T[keyof T] | Sttore<any>>;
